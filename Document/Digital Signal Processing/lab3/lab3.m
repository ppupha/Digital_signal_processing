function lab3()
    ...
    % Convolution
    % Фурье-образ взаимной �?вертки равен произведению Фурье-образов
    % �?вертываемых функций.
    ...
    xlabel('mult')
    ylabel('u(x) / A')
    plot(t, x1(1:sizeT), 'k', t, x2(1:sizeT), 'b', t, y1(1:sizeT), 'r');
    title('Rectangular and Gaussian convolution');
    legend('Pulse 1', 'Pulse 2', 'Convolution');

    figure(2)
    plot(t, x1(1:sizeT), 'k', t, x3(1:sizeT), 'b', t, y2(1:sizeT), 'r');
    title('Twice Rectangular convolution');
    legend('Pulse 1', 'Pulse 2', 'Convolution');

    figure(3)
    plot(t, x2(1:sizeT), 'k', t, x4(1:sizeT), 'b', t, y3(1:sizeT), 'r');
